  ...
  >
    ...
    <span class="visually-hidden">Next</span>
        ...
        <div class="  flex flex-col  w-full mb-10">
            <div class="bg-orange-500 w-[600px] mb-4 text-center rounded-3xl ml-[300px]   font-medium">
         <h1 class="sm:text-3xl text-2xl mt-2 text-center font-medium  text-white">श्रीनिवास वेंकटेश मन्दिर (तिरुपति बाला जी)  </h1>
         </div>
          <p class=" mx-auto justify-between text-justify leading-[50px] text-xl">
...
<br ></br>
<div class="bg-orange-500 w-[300px] text-center rounded-3xl ml-[400px] text-white  font-medium">
