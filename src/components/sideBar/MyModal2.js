...
export default function MyModal2({visible, onClose}) {
  ...
  return (
    ...
    <div  id="container" className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center z-40">
...
Donate Now          </button>
          <button  onClick={onClose} className="px-5 py-2 bg-blue-700 text-white rounded ml-5">
            Close          </button> 
        </div>
      </div>
    </div>
